...
mod tests {
    ...
    fn voted_slots_pruned_at_finalization() {
        ...
        // Simulate finalization at slot 10 by calling the pruning logic.
        // We need the consensus to report finalized_slot >= 10 for pruning.
        // Directly test the retain logic:
        let finalized = 10u64;
